...
import com.example.nmedia.databinding.ActivityMainBinding.inflate
...
class PostViewHolder(
    ...
    fun bind(post: Post) {
        with(binding) {
            ...
            if (post.likedByMe) {
                liked?.setImageResource(R.drawable.favorite_pink)
            } else {
                liked.setImageResource(R.drawable.favorite)
            }
